...
//		/* 获取主题中定义的toolbar的高度 */
//		int toolBarSize = (int) typedArray.getDimension(R.dimen.abc_action_bar_content_inset_material, 0);
////		int toolBarSize = (int) typedArray.getDimension((int) mContext.getResources().getDimension(	R.dimen.abc_action_bar_default_height_material));
//		typedArray.recycle();
//		/* 如果是悬浮状态，则不需要设置间距 */
