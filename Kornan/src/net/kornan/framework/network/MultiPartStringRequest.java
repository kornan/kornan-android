...
public class MultiPartStringRequest extends Request<String> implements
	...
	// private IdentityHashMap<String,File> fileUploads = new
	// IdentityHashMap<String,File>();
	private ArrayList<Map<String, File>> fileUploads = new ArrayList<Map<String, File>>();
	...
	public void addFileUpload(HashMap<String, File> map) {
		fileUploads.add(map);
	}
